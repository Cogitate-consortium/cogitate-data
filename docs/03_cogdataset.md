...
<img src="images/image4.png" width="" alt="alt_text" title="image_tooltip">
  ...
  <tr>
   <td>Standard locations of EOG and ECG electrodes
   </td>
  </tr>
</table>
...
<img src="images/image5.png" width="" alt="alt_text" title="image_tooltip">
  ...
  <tr>
   <td>Standard locations of HPI coils.
<p>
...
Following the empty room and rM-EEG recordings, subjects were asked to complete the task defined in the [Procedure](#bookmark=kix.uyqkbz5vq57p) section.

<table>
  <tr>
   <td><strong>Task</strong>
   </td>
   <td><strong>Runs</strong>
   </td>
   <td><strong>Blocks</strong>
   </td>
   <td><strong>Trials</strong>
   </td>
   <td><strong>Total trials</strong>
   </td>
  </tr>
  <tr>
   <td>Experiment 1
...
Complete standard procedure of an M-EEG session is available in [MEG Standard Operating Procedure](https://s.gwdg.de/XGuauC).
